...
export function HelpContent() {
  return (
    <Body>
      ...
      <p className="mb-1">不具合のご報告・ご意見は、運営までお気軽にご連絡ください。</p>
      <Link
        href="/settings/inquiry"
        className="inline-block mb-3 text-[13px] font-bold text-[#B45309] underline underline-offset-2 hover:opacity-80 active:opacity-60"
      >
        お問い合わせフォームはこちら
      </Link>
      <p className="mb-4">いただいた声はサービスの改善に活用させていただきます。</p>
