...
export function SignupProfileIntroStep({ onBack, onContinue, onSessionExpired }: Props) {
  ...
  return (
    <div
      className="signup-profile-intro font-sans flex flex-col min-h-[100dvh] bg-white px-6 pt-4 pb-8"
    >
      <div className="w-full max-w-[360px] md:max-w-[400px] mx-auto flex flex-col flex-1 min-h-0">
        ...
        <div className="flex-1 min-h-0 flex flex-col items-center justify-center text-center">
          ...
          <h1 className="mt-8 text-[19px] md:text-[22px] font-black leading-snug text-[#111111]">
            プロフィールをつくろう！
          </h1>
          <p className="mt-3 text-[12px] md:text-[13px] font-bold leading-relaxed text-[#64748b] px-1">
